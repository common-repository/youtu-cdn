...
<div class="wrap">
		...
		<form method="post" action="">
			<table class="form-table">
				<tbody>
					...
					<tr>
						<th scope="row"><label for="appid">AppID</label></th>
	...
	<div id="youtu-upload">
		<p>
		同步图片功能只会将目前的本地图片上传到腾讯万象优图，不会影响本地数据，初次使用本插件需要执行一次同步图片操作，以便上传旧数据，以后如果发现本地图片有未上传到万象优图的，也可以执行同步图片操作。<br />
		提醒：本操作不会覆盖万象优图中已有的图片，仅为增量上传，如果需要替换万象优图上的图片，请先在图片管理中删除相应的图片再同步图片。<br />
		注意：本操作需要依赖WordPress的WP-Cron定时任务功能，请不要禁用该功能，以免造成功能错误或者同步失败。<br />
		</p>
	...
	<hr />
	By.<a href="http://www.xmgo.cc/">All-Right</a>|YouTu-CDN|Version<?php echo wp_youtu_version; ?>|<a href="http://www.xmgo.cc/YouTu-CDN">点击获取最新版本&详细说明</a><br />
</div>
<?php
}
?>