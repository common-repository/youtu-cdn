...
<script type="text/javascript" src="<?php echo WP_PLUGIN_URL . '/' . dirname(plugin_basename(__FILE__)) . '/js/youtu.js'; ?>"></script>
<div class="wrap">
	<p><h2>YouTu-CDN 图片管理</h2></p>
	...
	<p>已上传到万象优图的图片列表，删除图片不会删除本地图片，仅会删除万象优图上的图片。</p>
	<hr />
